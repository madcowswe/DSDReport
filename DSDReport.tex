...
\begin{table}[tbp]
	\caption{Resource usage of entire system with different types of multipliers used. Columns are logic elements, combinational functions, registers, memory bits and 9 bit multipliers.}
